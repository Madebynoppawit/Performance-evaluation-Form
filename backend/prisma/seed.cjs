    ...
    data: [
      {
        ...
        goalDescription: 'Demo KPI — % of required reports closed on time within SLA.',
      ...
      },
      {
        ...
        goalDescription: 'Demo KPI — average request turnaround in business days (lower is better).',
        wig: 'Customer Focus',
        kpiCategory: 'Process',
        weight: 50,
        targetRating5: '1',
