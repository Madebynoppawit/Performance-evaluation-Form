...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'kbt-green': '0 0 20px rgba(0,168,107,0.3)',
      ...
      backgroundImage: {
        'kbt-gradient': 'linear-gradient(135deg, #00a86b 0%, #0a6ed1 58%, #292552 100%)',
        'kbt-gradient-dark': 'linear-gradient(135deg, #07111f 0%, #0b1530 58%, #292552 100%)',
        'brand-line': 'linear-gradient(90deg, #00a86b 0%, #0a6ed1 58%, #ed1c24 100%)',
