...
export const APP_VERSION = import.meta.env.VITE_APP_VERSION || '1.4.3'
...
export const RELEASE_FLAVOR_LABEL = AI_FEATURES_ENABLED ? 'AI Preview' : RELEASE_CHANNEL === 'demo' ? 'Demo' : 'Standard'
